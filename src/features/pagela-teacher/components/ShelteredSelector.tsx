...
type Props = {
  loading: boolean;
  items: ShelteredSimpleResponseDto[];
  value: ShelteredSimpleResponseDto | null;
  onChange: (sheltered: ShelteredSimpleResponseDto | null) => void;
  onSearch: (q: string) => void;
};

export default function ShelteredSelector({ loading, items, value, onChange, onSearch }: Props) {
  return (
    <Autocomplete
      fullWidth
      options={items}
