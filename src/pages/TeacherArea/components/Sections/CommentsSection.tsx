...
const CommentsSection: React.FC = () => {
  ...
  const handleSubmit = async () => {
    const newErrors = {
      ...
      shelterinho: !formData.shelterinho.trim(),
    ...
    try {
      ...
      setFormData({ name: '', comment: '', shelterinho: '', neighborhood: '' });
      setErrors({ name: false, comment: false, shelterinho: false, neighborhood: false });
      setFormOpen(false);
                ...
                >
                  <CardContent sx={{ p: { xs: 2, md: 4 } }}>
                    ...
                    <Grid container spacing={{ xs: 2, md: 3 }} sx={{ mb: { xs: 2, md: 3 } }}>
                      {['name', 'comment', 'shelterinho', 'neighborhood'].map((field) => (
